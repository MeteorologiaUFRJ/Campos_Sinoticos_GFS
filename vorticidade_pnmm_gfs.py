...
file_0 = xr.open_dataset(
    '/home/coqueiro/Downloads/GFS_Global_0p25deg_20220830_1200.grib2_multi.nc4',
    decode_times = False,
    )
...
#     '/home/coqueiro/Downloads/GFS_Global_0p25deg_ana_20220830_1200.grib2 _pnmm.nc4'
#     ).metpy.parse_cf()
...
for i in range(len(file_1.variables['time'])):
    ...
    # Add a title
    plt.title('Vorticidade relativa (1/s) - '+ str(level),
              fontweight='bold', 
              fontsize=35, 
              loc='left'
              )
